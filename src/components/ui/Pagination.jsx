...
const Pagination = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <nav aria-label="Paginación" className="flex justify-center">
      ...
      <ul className="md:hidden inline-flex items-center gap-1 rounded-xl border border-slate-700 bg-slate-900/90 px-2 py-1 shadow-md">
      ...
      <ul className="hidden md:inline-flex items-center gap-2 rounded-2xl border border-slate-700 bg-slate-900/80 px-4 py-2 shadow-lg">
