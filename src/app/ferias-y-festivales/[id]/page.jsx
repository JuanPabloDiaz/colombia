...
export default function FeriaYFestivalDetailPage() {
  ...
  if (!isLoading && !traditionalFairAndFestivalDetail) {
    return (
      <>
        <Head>
          <title>Feria o Festival no encontrado • Colombia 360</title>
        </Head>
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
          <div className="text-center p-10 bg-white shadow-lg rounded-lg">
            <h1 className="text-2xl font-bold text-red-600 mb-4">Feria o Festival no encontrado</h1>
            <p className="text-gray-700">
              No pudimos encontrar los detalles para la feria o festival con el ID: {id}.
            </p>
            <a href="/ferias-y-festivales" className="mt-6 inline-block px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
              Volver a la lista
            </a>
          </div>
        </div>
